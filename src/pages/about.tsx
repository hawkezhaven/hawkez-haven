    ...
    <div className="bg-[#f5f0e8]">
      ...
      <section className="bg-[#1a1a18] text-[#f5f0e8] py-24 md:py-32">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="mt-6 font-serif text-5xl md:text-6xl text-[#f5f0e8] leading-tight">
            More Than A Rescue.
          </h1>
          <p className="mt-6 text-lg text-[#f5f0e8]/70 leading-relaxed">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 grid lg:grid-cols-2 gap-14 items-center">
        ...
        <img
          ...
          loading="lazy"
          className="w-full rounded-3xl object-cover object-top aspect-[4/3] shadow-sm"
        />
      </section>
      ...
      <section className="bg-[#ede5d4] py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-14">
            <div className="flex items-center justify-center gap-3 mb-4 text-[#b8922a]">
              <span className="block h-px w-8 bg-[#b8922a]" />
            ...
            <p className="mt-4 text-[#4a4a42]">
              These five principles guide every interaction, every decision and every quiet moment in the paddock.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "We build trust first. A horse who feels safe will try far more willingly than one who is simply told what to do.",
              },
              {
                title: "Patience Before Pressure",
                desc: "Progress cannot be rushed. We give horses the time they need to understand, adjust and choose to participate.",
              },
              {
                title: "Understanding Before Judgement",
                desc: "Every behaviour tells a story. We look for the 'why' behind a reaction before deciding what comes next.",
              },
              {
                title: "Progress Over Perfection",
                desc: "Small steps matter. A quieter eye, a softer step, a willingness to approach — these are the victories we celebrate.",
              },
              {
                title: "Second Chances Always",
                desc: "No horse is beyond hope. With the right care, the right match and the right time, new beginnings are possible.",
              },
            ].map(({ title, desc }) => (
              <div key={title} className="bg-white rounded-2xl p-8 border border-[#ddd4be]/50 shadow-sm">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        <h2 className="font-serif text-4xl md:text-5xl text-[#1a1a18] max-w-2xl mx-auto">
          Every Great Journey Begins With Compassion.
        </h2>
        <p className="mt-4 text-[#4a4a42]">
          Whether you are hoping to adopt, sponsor, volunteer or simply learn more, there is a place for you in this story.
        </p>
