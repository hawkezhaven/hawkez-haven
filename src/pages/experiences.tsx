...
const EXPERIENCES: Experience[] = [
  {
    ...
    learn: [
      "Grooming techniques and why they matter",
      "Feed, nutrition and daily routines",
      "Rugging, health checks and water requirements",
      "Reading a horse's body language and mood",
      "What it truly costs to care for a horse",
    ],
  },
  {
    id: "groundwork",
    ...
    learn: [
      ...
      "Personal space, pressure and release",
      "Building trust through consistency",
      "Connection Before Correction in practice",
    ],
  },
  {
    id: "horsemanship",
    ...
    learn: [
      ...
      "How to read resistance versus confusion",
      "Building a genuine partnership",
      "Why trust must come before training",
    ],
  },
  {
    id: "riding",
  ...
  },
  {
    ...
    learn: [
      "What equine rescue really looks like",
      "The physical and emotional toll of neglect",
      "How we assess and plan each horse's rehabilitation",
      "Life after racing and competition",
      "How to advocate for better horse welfare in NZ",
    ],
  },
  {
    id: "family",
    ...
    learn: [
      "How horses communicate and show emotion",
      "Safe handling, grooming and feeding",
  ...
  },
  {
    ...
    learn: [
      "Senior horse care and needs",
      "What a companion home looks like",
      "Managing aging horses with kindness",
      "Quality of life decisions",
      "The profound gift of a peaceful retirement",
    ],
  },
];
