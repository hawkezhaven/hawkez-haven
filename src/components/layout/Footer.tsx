    ...
    <footer className="bg-[#1a1a18] text-[#f5f0e8] mt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid gap-14 lg:grid-cols-[1.3fr_1fr_1fr_1fr]">
        <div className="max-w-sm">
          <img src="/images/transparent-v2.webp" alt="Hawkez Haven" loading="lazy" className="h-16 w-auto object-contain brightness-0 invert sepia saturate-200 hue-rotate-10" />
        ...
        <div>
          ...
          <ul className="mt-5 space-y-3">
            {[{ label: "About Us", href: "/about" }, { label: "Meet Our Horses", href: "/horses" }, { label: "Horse Adoption", href: "/adoption" }, { label: "Sponsorship", href: "/sponsorship" }, { label: "Foster Program", href: "/foster" }].map(({ label, href }) => <li key={href}><Link to={href} className="text-sm text-[#f5f0e8]/75 hover:text-[#b8922a] transition-colors">{label}</Link></li>)}
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="mt-5 space-y-3">
            {[{ label: "Volunteer", href: "/volunteer" }, { label: "Education & Horsemanship", href: "/education" }, { label: "Support & Donate", href: "/support" }, { label: "The Hub", href: "/hub" }, { label: "Privacy Statement", href: "/privacy" }, { label: "Terms of Use", href: "/terms" }].map(({ label, href }) => <li key={label}><Link to={href} className="text-sm text-[#f5f0e8]/75 hover:text-[#b8922a] transition-colors">{label}</Link></li>)}
          </ul>
        </div>
      ...
      <div className="border-t border-[#f5f0e8]/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-[#f5f0e8]/50">
          <p>© 2021–2026 Hawkez Haven, Second Chances. Aotearoa, New Zealand.</p>
